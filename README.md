...
bm being Berryman's SCM + Voigt, and bmw being Berryman's SCM + Hill

Lastly, kt stands for Kuster-Toksöz, and vrh stands for Voigt-Reuss-Hill.

All subrepositries contain a run.py file and a jupyter notebook. Ran the python file and you will get the results from all 3 parameters.
